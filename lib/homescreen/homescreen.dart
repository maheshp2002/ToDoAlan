          ...
          leading: IconButton(
              icon: Icon(
                ...
                color: Theme.of(context)
                    .hintColor, // Change Custom Drawer Icon Color
              ),
          ...
          FadeAnimation(
            ...
            child: SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  _buildCategories(context, "Work", const Color(0xFFAC05FF),
                      todos.where((c) => c.category == "Work").length),
                  _buildCategories(context, "Personal", const Color(0xFF0011FF),
                      todos.where((c) => c.category == "Personal").length),
                  _buildCategories(
                      context,
                      "Sports",
                      Colors.red.withOpacity(0.6),
                      todos.where((c) => c.category == "Sports").length),
                  _buildCategories(
                      context,
                      "Education",
                      Colors.green.withOpacity(0.6),
                      todos.where((c) => c.category == "Education").length),
                  _buildCategories(
                      context,
                      "Medical",
                      const Color.fromARGB(255, 229, 255, 0),
                      todos.where((c) => c.category == "Medical").length),
                  _buildCategories(
                      context,
                      "Others",
                      const Color.fromARGB(255, 50, 239, 253),
                      todos.where((c) => c.category == "Others").length),
                ],
                      ...
                      onTap: () async {
                        ...
                        if (!todo.isCompleted) {
                          ...
                          try {
                            ...
                            if (isZero >
                                todos
                                    .where((c) => c.category == todo.category)
                                    .length) {
                              Fluttertoast.showToast(
                                  msg: 'Please be patient..!',
                                  toastLength: Toast.LENGTH_LONG,
                              ...
                              String hours =
                                  todo.time.toString().substring(0, 2);
                              String minutes =
                                  todo.time.toString().substring(3, 5);
                              List<int> date = [1, 2, 3, 4, 5, 6, 7];
